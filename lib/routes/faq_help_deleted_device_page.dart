...
class FaqHelpDeletedDevicePage extends StatefulWidget {
  const FaqHelpDeletedDevicePage({Key? key}) : super(key: key);
  @override
  State<FaqHelpDeletedDevicePage> createState() => _FaqHelpDeletedDevicePageState();
}

class _FaqHelpDeletedDevicePageState extends State<FaqHelpDeletedDevicePage> {
  bool? isResolved;
  ...
  List<Map<String, String>> getRelatedFaqs() {
    final currentRoute = '/faq-help-deleted-device';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _FaqStepItem(
                        index: 1,
                        title: '设备进入配对模式',
                        content: '长按设备电源键5秒，直到指示灯呈蓝色快速闪烁。',
                      ),
                      _FaqStepItem(
                        index: 2,
                        title: '重新添加设备',
                        content: '在APP首页点击“添加设备”，按照提示完成添加。',
                      ),
                    ],
                  ),
                ),
              ...
              // 相关问题
              const FaqRelatedQuestions(currentRoute: '/faq-help-deleted-device'),
            ],
          ),
        ),
      ),
