...
class _DataRechargePageState extends State<DataRechargePage> {
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  children: [
                    TextSpan(
                      text: '¥${selectedPrice.toStringAsFixed(selectedPrice == selectedPrice.round() ? 0 : 2)}',
                      style: const TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                        color: Color(0xFFFF9500),
  ...
  void _selectPackage(DataPackage package) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('已选择 ${package.data} 套餐'),
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('支付金额: ¥${selectedPrice.toStringAsFixed(selectedPrice == selectedPrice.round() ? 0 : 2)}'),
            ],
          ),
          actions: [
            TextButton(
